    ...
    )
    {
        ...
        )
        {
            ...
            var foreignKeyConstraints = foreignKeyResults
                ...
                .Select(gb =>
                {
                    return new DxForeignKeyConstraint(
                        ...
                        gb.Select(c => new DxOrderedColumn(c.column_name))
                            .ToArray(),
            ...
            var checkConstraints = checkConstraintResults
                ...
                .Select(c => new DxCheckConstraint(
                    c.schema_name,
                    c.table_name,
                    c.column_name,
                    c.constraint_name,
            ...
            var defaultConstraints = defaultConstraintResults
                ...
                .Select(c => new DxDefaultConstraint(
                    c.schema_name,
                    c.table_name,
                    c.column_name,
                    c.constraint_name,
            ...
            foreach (var tableColumn in tableColumns)
            {
                ...
                var (dotnetType, _, _, _) = GetDotnetTypeFromSqlType(tableColumn.data_type);
                ...
                var column = new DxColumn(
                    ...
                    primaryKeyConstraint != null && primaryKeyConstraint.Columns.Any(c =>
                        c.ColumnName.Equals(
                            tableColumn.column_name,
                            StringComparison.OrdinalIgnoreCase
                        )
